...
@javax.annotation.Generated(
    ...
    comments = "Source: buffer/chat.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ChatServiceGrpc {

  private ChatServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "buffer.ChatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.grpc.models.buffer.ChatMessage,
      com.grpc.models.buffer.ChatMessage> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = com.grpc.models.buffer.ChatMessage.class,
      responseType = com.grpc.models.buffer.ChatMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.grpc.models.buffer.ChatMessage,
      com.grpc.models.buffer.ChatMessage> getChatMethod() {
    io.grpc.MethodDescriptor<com.grpc.models.buffer.ChatMessage, com.grpc.models.buffer.ChatMessage> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod =
              io.grpc.MethodDescriptor.<com.grpc.models.buffer.ChatMessage, com.grpc.models.buffer.ChatMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.models.buffer.ChatMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.grpc.models.buffer.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.grpc.models.buffer.ChatMessage> responseObserver) {
  ...
  public static final class ChatServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.grpc.models.buffer.ChatMessage> chat(
        io.grpc.stub.StreamObserver<com.grpc.models.buffer.ChatMessage> responseObserver) {
  ...
  public static final class ChatServiceBlockingV2Stub
    ...
    public io.grpc.stub.BlockingClientCall<com.grpc.models.buffer.ChatMessage, com.grpc.models.buffer.ChatMessage>
        chat() {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.grpc.models.buffer.ChatMessage,
              com.grpc.models.buffer.ChatMessage>(
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.models.buffer.Chat.getDescriptor();
    }
